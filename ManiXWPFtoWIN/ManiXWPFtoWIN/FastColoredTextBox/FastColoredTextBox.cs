...
namespace ManiX
{
    ...
    public class FastColoredTextBox : UserControl
    {
        ...
        private new Size AutoScrollMinSize
        {
            set
            {
                if (scrollBars)
                {
                    ...
                    {
                        base.Invoke((new MethodInvoker(delegate() { base.AutoScrollMinSize = newSize; })));
                    }
                    else
                    {
        ...
        private void dria(Size newSize)
        {
            ...
            try
            {
                if (VerticalScroll.Visible || !ShowScrollBars)
                {
                    if (this.InvokeRequired)
                        this.Invoke((MethodInvoker)delegate { VerticalScroll.Value = v; });
                    else
                ...
                {
                    if (this.InvokeRequired)
                        this.Invoke((MethodInvoker)delegate { HorizontalScroll.Value = h; });
                    else
...
#endif
            //
            //this.BackBrush = new LinearGradientBrush(this.ClientRectangle, Color.White, Color.Silver,
